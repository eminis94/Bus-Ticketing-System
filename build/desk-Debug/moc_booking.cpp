...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Booking_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Booking_t qt_meta_stringdata_Booking = {
    {
        QT_MOC_LITERAL(0, 7),  // "Booking"
        QT_MOC_LITERAL(8, 21),  // "on_bookButton_clicked"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 24)   // "on_historyButton_clicked"
    },
    "Booking",
...
Q_CONSTINIT static const uint qt_meta_data_Booking[] = {
...
Q_CONSTINIT const QMetaObject Booking::staticMetaObject = { {
    ...
    qt_meta_stringdata_Booking.offsetsAndSizes,
...
void Booking::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_bookButton_clicked(); break;
